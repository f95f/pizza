...
<div class="container">
    ...
    <section class="section wow fadeIn" data-wow-delay="0.3s">
        ...
        @component('components.feature-heading', ['textcolor' => 'indigo', 'title' => 'título', 'corpo' => 'sla'])
        @endcomponent
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                @component('components.textblock', ['icon' => 'fa-flask', 'textcolor' => 'indigo', 'title' => 'sla'])
                @endcomponent
                @component('components.textblock', ['icon' => 'fa-magic', 'textcolor' => 'orange', 'title' => 'sla'])
                @endcomponent
                @component('components.textblock', ['icon' => 'fa-bolt', 'textcolor' => 'lime', 'title' => 'sla'])
                @endcomponent
