...
@component('public-components.banner');
@endcomponent

<div class="container-fluid px-0">

    @component('public-components.faixa',[
        'fundo' => '--ORANGISH',
    ...
    <div class="container py-5">
        ...
        <section class="text-center wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-name: fadeIn; animation-iteration-count: 1; animation-delay: 0.3s;">
            ...
            <div class="row mt-5">
                ...
                @component('public-components.card-sobre', [
        ...
        <div class=" mask rgba-black-strong py-5">
            ...
            <div class="container mx-auto">
                <div class="row">
                    ...
                    @component('public-components.pizza-tamanhos',[
                        'titulo' => 'Fatias',
                        'icone' => 'pizza_fatias',
        ...
        <div id="multi-item-example" class="carousel slide carousel-multi-item" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item">
                    ...
                    @component('public-components.card-promo', [
                        'tipo' => 'Tradicional',
                        'sabor' => 'Mussarela',
                        'imagem' => 'mussarela'
                    ])
